...
public class jdbcUserDaoTests extends tenmoDaoTests{
    ...
    public void getUser_returns_username() {
        User user = sut.findByUsername(" ");
        assertUserMatch(USER_1, user);
    }

    @Test
    public void getUserId_by_Username() {
        int actualUserId = sut.findIdByUsername("");
    ...
    @Test
    public void getUsername_return_null() {
        User noUsername = sut.findByUsername("");


        Assert.assertNull(noUsername);

    }

    @Test
    public void getUserId_return_null() {
        int noUserId = sut.findIdByUsername("");
        Assert.assertNull(noUserId);
    }
    ...
    public void find_All_users_return_users() {
        ...
        User actual = actualResults.get(2);
